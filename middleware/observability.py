    ...
    def process_exception(self, request, exception):
        ...
        logger.exception(
            ...
            extra={
                ...
                "response_bytes":getattr(exception, "content", None).__sizeof__() if hasattr(exception, "content") else None,
                "duration_sec": duration
            }
        )

    def process_response(self, request, response):
        correlation_id = getattr(request, "correlation_id", generate_correlation_id())
        duration = None
